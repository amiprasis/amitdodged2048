...
var dogeSayings = ['one amit died', 'amit died again', 'amit died again and again', 'u are killing me!', 'please dont kill me', 'why u so ruthless', 'so u wont stop?', 'u CSMF!', 'u r taking it as a game MF!', 'u r a killer!', 'u must not b a human!' ,'i wont spare u if dont make 20k',
'u suck yourself', 'even a toddler can make it, dont b so proud', 'u r such an asshole', 'so boring', 'go for suicide attempt', 'clean the mess and quit this game', 'CSMFs will always be CSMFs', 'so tired of watching u', 'dont match me, i will match u after the game', 'shameful! the shit u r playing' ,'get ready to die',]
